<?php
 ...
 //       $password = md5($_POST['u_password']);       // This is for encrypted password when password save in databases in the encrypted form....
        ...
        {
            $msg = "<font color='white'> Invalid Username and Password </font>";
        }
        mysqli_close($link);
        }
?>
        ...
        <div class="container-fluid" style="padding:0px;">
            <section class="row" >
                <div class="deep">
                    ...
                    <div class="col-sm-2 clogo"><img src="images/EasyDay_logo.png" alt="" width="90%" height="80px" ">
                ...
                <div class="col-sm-6">
                    <form method="post" style="padding-top:100px;">
                        ...
                        <div class="jumbotron" style="background-color: palevioletred;">
                            ...
                            <center style="font-size:25px; color:#330bd6; font-family: new times roman"> !!! Login !!! </center>
